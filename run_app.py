...
def main():
    ...
    try:
        ...
        print("=" * 60)
        print("\n✓ El Asistente de Escritorio se ha cerrado correctamente.")
        print("  Puedes volver a ejecutarlo con: python3 run_app.py\n")
        sys.exit(0)
...
if __name__ == '__main__':
    try:
        ...
        print("\n")
        print("=" * 60)
        print("🛑 Aplicación detenida por el usuario (Ctrl+C)")
        print("=" * 60)
        print("\n✓ El Asistente de Escritorio se ha cerrado correctamente.")
        print("  Puedes volver a ejecutarlo con: python3 run_app.py\n")
        sys.exit(0)